...
function makeRequest(url=base_url+"/api/historic/historic/all/?column_name=Shp.status&search_query=Booked") {
    var token = getToken();
    $.ajax({
        url: url,
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            console.log(response.domestic_linehaul);
            console.log(response.retail_handling);
