...
function makeRequest(url="http://127.0.0.1:8000/api/historic/historic/wholesale_distribtion/") {
    $.ajax({
        url: url,
...
function downloadRequest(object){
    ...
    $.ajax({
        url: 'http://127.0.0.1:8000/api/historic/historic/download/',
...
function filterDate(){
  ...
  makeRequest('http://127.0.0.1:8000/api/historic/historic/wholesale_distribtion/?start_date='+start_date+"&end_date="+end_date)
}

function filterContent(){
  search = document.getElementById("search").value
  makeRequest('http://127.0.0.1:8000/api/historic/historic/wholesale_distribtion/?search='+search)
}
