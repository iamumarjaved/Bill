...
function makeRequest(url="http://127.0.0.1/api/historic/historic/giacenze_vs_lgi/") {
    var token = getToken();
    $.ajax({
        url: url,
...
function filterDate(){
  ...
  makeRequest('http://127.0.0.1/api/historic/historic/giacenze_vs_lgi/?start_date='+start_date+"&end_date="+end_date)
}

function filterContent(){
  search = document.getElementById("search").value
  makeRequest('http://127.0.0.1/api/historic/historic/giacenze_vs_lgi/?search='+search)
}
