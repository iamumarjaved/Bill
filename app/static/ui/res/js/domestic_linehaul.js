...
function filterDate(){
  ...
  makeRequest(base_url+'/api/historic/historic/domestic_linehaul/?start_date='+start_date+"&end_date="+end_date)
}

function filterContent(){
  search = document.getElementById("search").value
  makeRequest(base_url+'/api/historic/historic/domestic_linehaul/?search='+search)
}
